...
function handleSubmit() {
  if (selectedEvent1.value) {
    sendBookingData(selectedEvent1.value);
  }
}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              />
                ...
                <BaseInput
                  v-model.trim="selectedEvent1.firstname"
                  v-focus
                  label="First name"
                />
                ...
                <BaseInput
                  v-model.trim="selectedEvent1.lastname"
                  v-focus
                  label="Last name"
                />
        
                <BaseInput
                  v-model.trim="selectedEvent1.email"
                  v-focus
                  type="email"
                  label="Eamil name"
                />
                <BaseInput
                  v-model.trim="selectedEvent1.phone"
                  v-focus
                  type="phone"
                  label="phone"
                />
                ...
                <BaseInput
                v-model.trim="selectedEvent1.date"
                v-focus
                type="date"
                label="date"
              />
              ...
              <BaseInput
              v-model.trim="selectedEvent1.time"
              v-focus
              type="time"
              label="time"
            />
                ...
                <!-- Category Dropdown -->
            <BaseListbox
            v-model.prop="selectedEvent1.service"
            label="Service"
          ...
          <!-- Assignee Dropdown -->
          <BaseListbox
          v-model.prop="selectedEvent1.hairdresser"
          label="Hair Dresser"
